    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">更新文章
                    @can('delete-post', $post)
                        <a class="pull-right btn btn-sm btn-danger" href="{{ route('delete_post', ['post' => $post->id]) }}"
                        onclick="if(!confirm('确定删除吗？')) { return false; } else {
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('update_post', ['post' => $post->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            <label for="body" class="col-md-2 control-label">內容</label>
